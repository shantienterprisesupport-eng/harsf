...
export default function App() {
  ...
  return <main>
    ...
    <section className="hero"><div className="eyebrow"><CircleDot size={13}/> AI CEO autopilot online</div><h1>Idea bolo. AI company<br/><span>plan aur build karegi.</span></h1><p>Safe workflow automatically advances through product, architecture, code, QA, security, bug-fix and retest. Protected actions stay under your approval.</p></section>

    <div className="layout">
      <section className="chat panel">
        <div className="panel-title"><div><h2>CEO Chat</h2><p><Languages size={14}/> Odia · Hindi · Hinglish · English</p></div><span className="live">AUTOPILOT</span></div>
    ...
    <footer><span>Ruflo-ready orchestration</span><span>Safe tasks run automatically</span><span>No secrets stored in UI</span></footer>
  </main>;
}
